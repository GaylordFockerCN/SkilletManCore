...
public class WeaponGachaSystem {
    ...
    public static void initItemList() {
        ...
        STAR4_LIST.addAll(List.of(Items.BOW.getDefaultInstance(), Items.BOW.getDefaultInstance(), Items.BOW.getDefaultInstance(), SMCItems.GOOD_SUPER_GOLEM_SPAWN_EGG.get().getDefaultInstance()));
