...
public class SuperGolemRenderer extends MobRenderer<SuperBadIronGolem, IronGolemModel<SuperBadIronGolem>> {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull SuperBadIronGolem superBadIronGolem) {
